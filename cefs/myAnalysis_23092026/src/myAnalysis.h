...
//        eventNumber = 0;
    ...
    int sumHitsEcal = 0;
    int sumHitsHcal = 0;
    int sumClustersEcal = 0;
    int sumClustersHcal = 0;
    // Event-level energy sums
    double sumEcalE = 0.0;
    double sumHcalE = 0.0;

    std::vector<double> pfoEcalE, pfoHcalE;
...
private:
    ...
    struct ClusterHitStats {
        ...
        double eEcal = 0.0;    // Суммарная энергия ECAL-кластеров
        double eHcal = 0.0;    // Суммарная энергия HCAL-кластеров
