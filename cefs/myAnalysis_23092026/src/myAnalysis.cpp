...
StatusCode myAnalysis::initialize() {
    ...
    myOutputTree->Branch("pfoEcalE", &myEventData.pfoEcalE);
    myOutputTree->Branch("pfoHcalE", &myEventData.pfoHcalE);
    // Event-level hit sums
    myOutputTree->Branch("sumHitsEcal",     &myEventData.sumHitsEcal);
    myOutputTree->Branch("sumHitsHcal",     &myEventData.sumHitsHcal);
    myOutputTree->Branch("sumClustersEcal", &myEventData.sumClustersEcal);
    myOutputTree->Branch("sumClustersHcal", &myEventData.sumClustersHcal);
    // Event-level energy sums
    myOutputTree->Branch("sumEcalE", &myEventData.sumEcalE);
    myOutputTree->Branch("sumHcalE", &myEventData.sumHcalE);
...
StatusCode myAnalysis::execute() {
    ...
    for (const auto &pfo : *myPfoCollPtr) {
        ...
        if (myCollectHitStats.value()) {
            ...
            // Event-level sums
            myEventData.sumHitsEcal     += hitStats.nHitsEcal;
            myEventData.sumHitsHcal     += hitStats.nHitsHcal;
            myEventData.sumClustersEcal += hitStats.nClustersEcal;
            myEventData.sumClustersHcal += hitStats.nClustersHcal;
            // Event-level energy sums
            myEventData.sumEcalE += hitStats.eEcal;
            myEventData.sumHcalE += hitStats.eHcal;
            // Per-PFO energy
            myEventData.pfoEcalE.push_back(hitStats.eEcal);
            myEventData.pfoHcalE.push_back(hitStats.eHcal);
            ...
            myEventData.pfoEcalE.push_back(-1.0);
            myEventData.pfoHcalE.push_back(-1.0);
