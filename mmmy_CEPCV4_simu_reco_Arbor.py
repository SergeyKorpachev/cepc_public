...
totalInvM.TreeOutputFile = "Examples/options/CEPCV4_simu_reco_Arbor_Pqq_5evt_BMRAna.root"
# totalInvM.TreeOutputFile = "BMRFile"
totalInvM.MCPCollectionName = "MCParticleGen"
# totalInvM.MCPCollectionName = "MCParticle"
##############################################################################
# MyProcessor analysis
from Configurables import MyProcessor
my_proc = MyProcessor("MyProcessor")
my_proc.TreeOutputFile = "Examples/options/CEPCV4_simu_reco_Arbor_Pqq_5evt_MyProcessorAna.root"
# my_proc.TreeOutputFile = "MyProcessorFile"
my_proc.MCPCollectionName = "MCParticleGen"
# my_proc.MCPCollectionName = "MCParticle"
##############################################################################
# write PODIO file
from Configurables import PodioOutput
write = PodioOutput("write")
write.filename = "Examples/options/CEPCV4_simu_reco_Arbor_Pqq_5evt_Reco.root"
...
ApplicationMgr(
    ...
    TopAlg = [genalg, detsimalg, digiVXD, digiSIT, digiSET, digiFTD, spSIT, spFTD, digiTPC, clupatra, tracking, forward, subset, full, simHitMerge, caloDigi, marlinArbor, bushconnect, totalInvM, my_proc, write],
    EvtSel = 'NONE',
    EvtMax = 5,
